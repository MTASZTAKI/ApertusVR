...
Library and Plugin to use glTF 2.0 resources with Ogre 2.1 distributed under the terms of the [MIT License](https://opensource.org/licenses/MIT "MIT Licence on the OSI website")
