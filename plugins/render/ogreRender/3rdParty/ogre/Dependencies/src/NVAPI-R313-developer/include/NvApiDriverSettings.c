...
EValues_WKS_FEATURE_SUPPORT_CONTROL g_valuesWKS_FEATURE_SUPPORT_CONTROL[WKS_FEATURE_SUPPORT_CONTROL_NUM_VALUES] = 
{
    ...
    WKS_FEATURE_SUPPORT_CONTROL_WIN8_STEREO_EXPORT_IF_ENABLED,
};
...
SettingDWORDNameString mapSettingDWORD[TOTAL_DWORD_SETTING_NUM] = 
{
    ...
    {PREFERRED_PSTATE_ID,                  PREFERRED_PSTATE_STRING,                   6, (NvU32 *)g_valuesPREFERRED_PSTATE,        PREFERRED_PSTATE_ADAPTIVE},
    {PS_FRAMERATE_LIMITER_ID,              PS_FRAMERATE_LIMITER_STRING,              17, (NvU32 *)g_valuesPS_FRAMERATE_LIMITER,    PS_FRAMERATE_LIMITER_DISABLED},
    ...
    {WKS_FEATURE_SUPPORT_CONTROL_ID,       WKS_FEATURE_SUPPORT_CONTROL_STRING,        3, (NvU32 *)g_valuesWKS_FEATURE_SUPPORT_CONTROL, WKS_FEATURE_SUPPORT_CONTROL_SRS_1714_WIN8_STEREO},
