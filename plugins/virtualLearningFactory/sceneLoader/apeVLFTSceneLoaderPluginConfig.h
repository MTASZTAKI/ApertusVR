...
//
//     quicktype::Scene data = nlohmann::json::parse(jsonString);
...
namespace quicktype {
	...
	private:
		std::string id;
		std::string type;
		std::shared_ptr<std::vector<quicktype::Representation>> representations;
	...
	public:
		...
		std::shared_ptr<std::vector<quicktype::Representation>> get_representations() const { return representations; }
		void set_representations(std::shared_ptr<std::vector<quicktype::Representation>> value) { this->representations = value; }
