...
ape::WebSocketServerPlugin::WebSocketServerPlugin()
{
	...
	mpEventManager->connectEvent(ape::Event::Group::NODE, std::bind(&WebSocketServerPlugin::eventCallBack, this, std::placeholders::_1));
...
{
	APE_LOG_FUNC_ENTER();
	mpEventManager->disconnectEvent(ape::Event::Group::NODE, std::bind(&WebSocketServerPlugin::eventCallBack, this, std::placeholders::_1));
	APE_LOG_FUNC_LEAVE();
}
