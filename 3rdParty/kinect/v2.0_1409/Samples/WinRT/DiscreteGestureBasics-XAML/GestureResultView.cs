...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        private readonly ImageSource seatedImage = new BitmapImage(new System.Uri("ms-appx:///Images/Seated.png"));

        /// <summary> Image to show when the 'detected' property is false for a tracked body </summary>
        private readonly ImageSource notSeatedImage = new BitmapImage(new System.Uri("ms-appx:///Images/NotSeated.png"));

        /// <summary> Image to show when the body associated with the GestureResultView object is not being tracked </summary>
        private readonly ImageSource notTrackedImage = new BitmapImage(new System.Uri("ms-appx:///Images/NotTracked.png"));
        ...
        private readonly Brush[] trackedColors = new Brush[]
        { 
        ...
        /// <summary> Brush color to use when a body is not tracked </summary>
        private readonly Brush notTrackedColor = new SolidColorBrush(Colors.Gray);

        /// <summary> Brush color to use as background in the UI </summary>
        private Brush bodyColor = null;
        ...
        {
            this.BodyColor = this.notTrackedColor;
