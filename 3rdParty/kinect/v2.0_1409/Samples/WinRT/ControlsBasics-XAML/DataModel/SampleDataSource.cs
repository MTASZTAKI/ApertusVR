...
namespace Microsoft.Samples.Kinect.ControlsBasics.Data
{
    using System;
    ...
    public abstract class SampleDataCommon : Microsoft.Samples.Kinect.ControlsBasics.Common.BindableBase
    {
    ...
    public class SampleDataItem : SampleDataCommon
    {
            ...
            : base(uniqueId, title, subtitle, imagePath, description)
        {
            ...
            this._group = group;
            this._navigationPage = null;
        }

        public SampleDataItem(String uniqueId, String title, String subtitle, String imagePath, String description, String content, SampleDataGroup group, Type navigationPage)
            : base(uniqueId, title, subtitle, imagePath, description)
        {
            this._content = content;
            this._group = group;
        ...
        {
            get { return this._navigationPage; }
            set { this.SetProperty(ref this._navigationPage, value); }
        }
    }
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            ...
            var group1 = new SampleDataGroup("Group-1",
                    "Controls",
                    "Kinect-enabled controls for your app",
                    "Assets/DarkGray.png",
                    "These are some sample controls that have been enabled for Kinect and use custom styles designed for use on large displays");
            ...
            group1.Items.Add(new SampleDataItem("Group-1-Item-6",
                    ...
                    "Demonstrating using a ScrollViewer with horizontal and vertical rails and zoom.",
                    ITEM_CONTENT,
                    group1,
            ...
            group1.Items.Add(new SampleDataItem("Group-1-Item-8",
                    "Viewing a set of Photos",
                    "",
                    "Assets/MediumGray.png",
                    "Photo Viewer using a FlipView control",
                    ITEM_CONTENT,
                    group1,
                    typeof(FlipViewSample)));
            group1.Items.Add(new SampleDataItem("Group-1-Item-9",
                    "Lists",
                    "",
                    "Assets/LightGray.png",
                    "Demonstrating list interactions with Kinect.",
                    ITEM_CONTENT,
                    group1,
                    typeof(ItemsControlsSample)));
            group1.Items.Add(
                    new SampleDataItem(
                    "Group-1-Item-6",
            ...
            group1.Items.Add(new SampleDataItem("Group-1-Item-7",
                    ...
                    "",
                    "Assets/DarkGray.png",
                    "Enables user to switch between engagement models and cursor sprites.",
                    ITEM_CONTENT,
                    group1,
