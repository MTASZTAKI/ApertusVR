...
namespace Microsoft.Samples.Kinect.ControlsBasics
{
    ...
    public class HandInScreenEngagementModel : IKinectEngagementManager
    {
        ...
        public HandInScreenEngagementModel(int engagedPeopleAllowed, InputPointerManager inputPointerManager)
        {
        ...
        private static bool IsHandInScreen(Point unclampedHandPosition)
        {
            return (unclampedHandPosition.X >= 0.0 && unclampedHandPosition.X <= 1.0);
        }

        private bool IsHandBelowScreen(Point unclampedHandPosition, uint pointerId)
        {
            ...
            var manipulatableModels = this.inputPointerManager.GetCapturedInputModel(pointerId);
            int manipulatableModelsCount = manipulatableModels == null ? 0 : manipulatableModels.ManipulationAwareElements.Count;
            return (unclampedHandPosition.Y > 1.1 && manipulatableModelsCount == 0);
        }
