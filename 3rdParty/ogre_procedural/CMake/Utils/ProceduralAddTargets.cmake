  ...
  if (OgreProcedural_UNITY_BUILD)
    ...
    foreach(_FILE ${_PRIMARY})
      ...
      if (((_EXT STREQUAL ".cpp") OR (_EXT STREQUAL ".cxx")) AND (_EXCLUDED EQUAL "-1"))
        ...
        if(_FILE_CNT EQUAL OgreProcedural_UNITY_FILES_PER_UNIT)
          set(_FILENAME "${OgreProcedural_BINARY_DIR}/${TARGETNAME}/compile_${TARGETNAME}_${_FILE_NUM}.cpp")
...
# usage: procedural_add_library(TARGETNAME LIBTYPE SOURCE_FILES [SEPARATE SOURCE_FILES])
function(procedural_add_library TARGETNAME LIBTYPE)
  create_unity_build_files(${TARGETNAME} ${ARGN})
  add_library(${TARGETNAME} ${LIBTYPE} ${_SOURCES})
endfunction(procedural_add_library)


# add a new executable target
# usage: ogre_add_executable(TARGETNAME [WIN32] [MACOSX_BUNDLE] SOURCE_FILES [SEPARATE SOURCE_FILES])
function(procedural_add_executable TARGETNAME)
