...
namespace Hydrax
{
	 ...
	 */
	class HydraxDllExport MaterialManager : public Ogre::MaterialManager::Listener
	{
	public:
		/** Material type enum
      ...
      virtual void notifyResourcesCreated(bool forResizeOnly);
		 ...
		 */
		bool createMaterials(const HydraxComponent &Components, const NormalMode& normalMode);
    ...
    void addCompositor(Ogre::Viewport* viewport);
    void removeCompositor(Ogre::Viewport* viewport);
		 ...
		 */
		bool fillGpuProgramsToPass(Ogre::Pass* Pass, const Ogre::String GpuProgramNames[2], const Ogre::String EntryPoints[2], const Ogre::String Data[2]);
		...
		/** Create GPU program
			...
			@param Data
		 */
		bool createGpuProgram(const Ogre::String &Name, const GpuProgram& GPUP, const Ogre::String& EntryPoint, const Ogre::String& Data);
    ...
    @copydoc Ogre::MaterialManager::Listener::handleSchemeNotFound
    */
	...
	private: 
		...
		/** Create water material
			...
			@param Options Material options
		 */
		bool _createWaterMaterial(const HydraxComponent &Components, const NormalMode& normalMode);

		/** Create depth material
		    @param Components Components of the shader
			@param Options Material options
		 */
		bool _createDepthMaterial(const HydraxComponent &Components, const NormalMode& normalMode);

    /** Create depth material with alpha reject discar
		    @param Components Components of the shader
			@param Options Material options
		 */
		bool _createDepthMaterialTrans(const HydraxComponent &Components, const NormalMode& normalMode);
		 ...
		 */
		bool _createDepthTextureGPUPrograms(const HydraxComponent &Components, const NormalMode& normalMode, const Ogre::String& AlphaChannel);

		/** Create underwater material
		    @param Components Components of the shader
			@param Options Material options
		 */
		bool _createUnderwaterMaterial(const HydraxComponent &Components, const NormalMode& normalMode);

		/** Create underwater compositor
		    @param Components Components of the shader
			@param Options Material options
		 */
		bool _createUnderwaterCompositor(const HydraxComponent &Components, const NormalMode& normalMode);
    ...
    std::vector<Ogre::Technique*> mDepthTransTechniques;
