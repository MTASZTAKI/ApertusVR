...
namespace Hydrax
{
     ...
     */
    class HydraxDllExport Hydrax : public Ogre::RenderTargetListener
    {
    public:
      typedef std::set<Ogre::Viewport*> ViewportList;
         ...
         */
		    Hydrax(Ogre::SceneManager *sm, Ogre::Viewport *v);
        ...
        void registerViewport(Ogre::Viewport* viewport);
        void unregisterViewport(Ogre::Viewport* viewport);
        ...
        inline const bool& isDeviceLost() const
		    {
			    return mDeviceLost;
		    }
		     ...
		     */
		    inline ViewportList getViewports()
		    {
        ...
        /** update the simulation (not the rendering!) by the given amount of time
        @remark: must be called before the rendering, in a FrameStart event.
         */
        void update(const Ogre::Real& timeSinceLastFrame);

        /** @copydoc Ogre::RenderTargetListener::postViewportUpdate
         */
        ...
        */
        ...
        /** Set the rtt visibility mask
        */
        void setRttVisibilityMask(const Ogre::uint32& visibilityMask);

        /** Get the rtt visibility mask
        */
        const Ogre::uint32 getRttVisibilityMask() const;
    ...
    private:
        ...
        void _updateNM();
		     ...
		     */
		    void _checkUnderwater(const Ogre::Camera* cam, const Ogre::Real& timeSinceLastFrame);
        ...
        /// Time multiplier, default to 1.0f
        Ogre::Real mTimeMultiplier;
        /// Time since the last frame (ie, last time all targeted viewport were updated).
        Ogre::Real mTimeSinceLastFrame;
        /// Visibility mask for Hydrax RTTs
        Ogre::uint32 rttVisibilityMask;
        Ogre::Camera* mCamera;
        bool mDeviceLost;
    };
}
