...
namespace Hydrax{ namespace Module
{
	...
	public:
		 ...
		 */
    virtual void update(const Ogre::Real &timeSinceLastFrame, const Ogre::Camera* renderingCamera = NULL);
	...
	private:
		 ...
		 */
		void _performChoppyWaves(const Ogre::Camera* renderingCamera);
		 ...
		 */
		bool _renderGeometry(const Ogre::Camera* renderingCamera, const Ogre::Matrix4& m,const Ogre::Matrix4& _viewMat, const Ogre::Vector3& WorldPos);
		 ...
		 */
	  bool _getMinMax(const Ogre::Camera* renderingCamera, Ogre::Matrix4 *range);
	  ...
	  Ogre::Vector3 mNormal, mPos;
		...
		bool mLastMinMax;
    Ogre::Vector3 mLastHydraxPosition;
    bool mForceUpdate;
