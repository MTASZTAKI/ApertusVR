...
#include "../Perlin/HydraxPerlin.h"
    ...
    #define _HydraxDensity_ 1025.0f
#endif
#ifndef _HydraxGravity_
    #define _HydraxGravity_ 9.81f
#endif
 ...
 * ship Kelvin wakes.
 */
class HydraxDllExport PressurePoint
{
public:
    /** Default constructor
     ...
     * @return Time elapsed.
     */
    inline float getTime() const{return static_cast<float>(mTime);}
    /** Returns wave length.
     * @return Wave length.
     */
